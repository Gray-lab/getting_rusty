fn main() {
    ...
    let a = [1, 2, 3, 4, 5]; // allocated on heap, fixed length
    let b: [i32; 5] = [1, 2, 3, 4, 5];  // explicitly type annotated
    let c = [3; 5]; // initializes an array with 5 elements all set to 3: [3, 3, 3, 3, 3]
